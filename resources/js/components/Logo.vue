<template>
    <div>
        ...
        <div class="mb-10">
            <picture style="height: 382px" class="block shadow flex items-center justify-center mb-6 rounded-lg">
        ...
        <div>
            <picture style="height: 382px" class="block shadow flex items-center justify-center mb-6 rounded-lg bg-blue">
                <img src="/images/negative-logo.svg" alt="logo">
            </picture>
            <div class="flex justify-between items-center">
                <p>
                    Negative logo on <strong>white</strong> background
                </p>
